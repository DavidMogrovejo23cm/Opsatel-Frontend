...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  const menuItems = [
    ...
    { path: '/hoja-ruta', label: 'Hoja de Ruta', icon: '🗓️', roles: ['administrador'] },
    { path: '/tecnica', label: 'Tecnico', icon: '🔧', roles: ['administrador'] },
    { path: '/ont', label: 'ONT', icon: '📡', roles: ['administrador'] },
