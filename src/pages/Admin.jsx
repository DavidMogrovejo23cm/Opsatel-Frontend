          ...
          <table style={{ width: '100%', borderCollapse: 'separate', borderSpacing: 0, textAlign: 'left' }}>
            <thead style={{ position: 'sticky', top: 0, background: '#15122e', zIndex: 20 }}>
              <tr style={{ background: '#15122e' }}>
                ...
                <th style={{ position: 'sticky', top: 0, background: '#15122e', zIndex: 20, padding: '12px 10px', borderBottom: '2px solid rgba(255, 255, 255, 0.15)', color: 'var(--text-muted)', whiteSpace: 'nowrap' }}>PENDIENTE</th>
